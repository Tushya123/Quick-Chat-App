...
export default function DeleteChatGroup({
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogContent className="relative z-50 bg-white">
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel className="hover:border-2 ">Cancel</AlertDialogCancel>
          <AlertDialogAction  disabled={loading} onClick={deleteChatGroup} className="hover:border-2 shadow-lg">
